...
const Topbar: React.FC = () => {
  ...
  return (
    <header className="flex h-16 shrink-0 items-center justify-between px-6 gap-2 transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-12 bg-sidebar text-sidebar-foreground border-b border-gray-200">
