...
export async function generateReportPdf(
  ...
  try {
    ...
    browser = await puppeteer.launch({
      ...
      headless: true,
      protocolTimeout: 180000, // Explicitly increase protocol timeout to 3 minutes
    });
    ...
    // Wait for the HTML content to be loaded and resources to settle
    ...
    // Close the page immediately after using it
    await page.close();
    ...
    if (browser) {
      try {
        ...
        console.warn('Error during browser cleanup:', cleanupError);
      }
    }
  }
}

// Keep the getBaseStyles function unchanged
